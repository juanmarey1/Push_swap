...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   find_closest_number_to_a.c                         :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: jrey-roj <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/08/26 15:34:00 by jrey-roj          #+#    #+#             */
/*   Updated: 2024/08/26 15:34:01 by jrey-roj         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	find_opt_moves(t_stack *stack)
{
	...
	else if ((stack->down_ab <= stack->up_ab
			&& stack->down_ab <= stack->up_a_down_b)
		&& stack->down_ab <= stack->down_a_up_b)
		return (stack->which_case = 2, stack->down_ab);
	else if ((stack->up_a_down_b <= stack->up_ab
			&& stack->up_a_down_b <= stack->down_ab
