...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/08/26 15:43:26 by jrey-roj          #+#    #+#             */
/*   Updated: 2024/08/26 15:43:28 by jrey-roj         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	find_cost_of_number(t_stack *stack, int num)
{
	...
	i = 0;
	j = 1;
	stack->list_b = *stack->stack_b;
	stack->list_a = *stack->stack_a;
	while (++i < num)
		stack->list_a = stack->list_a->next;
	num_a = (stack->list_a->content);
	num_b = find_closest_number(num_a, stack->list_b);
	while ((stack->list_b->content) != num_b)
	{
		j++;
